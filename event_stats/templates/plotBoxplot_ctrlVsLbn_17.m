...
g(1,1).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(1,2).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g.set_title('mEPSC Frequency - P17-18, all cell types');
...
g(2,1).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(2,2).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(3,1).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(3,2).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(4,1).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
g(4,2).set_color_options('map',[0.5 0.5 0.5;0 0 0;1 0 0]);
...
annotation('textbox', [0.5 0.49 0 0], 'string', 'mEPSC Amplitude - P17-18, all cell types',...
...
h = findobj('Marker','o','MarkerEdgeColor','none','MarkerFaceColor',[0.5 0.5 0.5]);
set(h,'MarkerEdgeColor',[0.5 0.5 0.5],'MarkerFaceColor','none');
