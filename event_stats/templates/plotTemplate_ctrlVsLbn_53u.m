...
g(1,2).set_color_options('map',[0 0 0;0 0.5 1]);
...
g(2,2).set_color_options('map',[0 0 0;0 0.5 1]);
...
g(3,2).set_color_options('map',[0 0 0;0 0.5 1]);
...
g(4,2).set_color_options('map',[0 0 0;0 0.5 1]);
...
annotation('textbox', [0.5 0.49 0 0], 'string', 'mEPSC Amplitude',...
           'FontSize',14,'FontWeight','bold','FitBoxToText','on',...
           'LineStyle','none',HorizontalAlignment='center');

% remove barchart color
h = findobj('FaceAlpha',1);     % all barchart objects share this property
