...
% Sort data into two groups according to cellTypes and create two 
% subcolumns, each will contain a panel for each cellType.
g(1,1).facet_grid([],cellstr(inputFreq.cellType));
...
g(1,1).set_color_options('map',[0 0 0;0 0.5 1]);

% Change column order
g(1,1).set_order_options("column",["tdtP","gfpP"]);
