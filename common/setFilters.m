function filters = setFilters(fileIndex)
...
% Read available variables in 'fileIndex' and remove unnecessary factors
var2remove = {'fileName','mouseID','recordDate', ...
              'DOB','age','include','events','meanValue'};
factors = getIndependentVar(fileIndex,var2remove);
