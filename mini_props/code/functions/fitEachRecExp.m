function [allparams,allgof]= fitEachRecExp(sortedData,groupIndex,groupName,sessionDir)
...
data = applyFilters(sortedData,groupIndex,groupName);
...
outputDir = [sessionDir '/exponFitting/' char(groupName) '/'];
