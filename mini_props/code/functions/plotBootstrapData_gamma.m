function plotBootstrapData_gamma(group,newFig,rgbColor)
% plotBootstrapData_gamma: Plot left-truncated gamma CDF for bootstrap
% data of amplitude.
...
inputDir = ['analysis/gammaFitting_bootstrap/'];
...
% plot median of cdf
plot(x,outcdf(2,:),'DisplayName',string(group),'Color',rgbColor);
