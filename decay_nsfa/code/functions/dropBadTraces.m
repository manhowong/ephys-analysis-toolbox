...
%   1 Trace tail falls outside a user-defined range relative to the average
%     trace. (This indicates unstable recording)
...
%   4 Trace has event peak occurring >= 1 ms later than the average peak.
