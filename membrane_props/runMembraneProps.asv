...
fname = 'MW220125_02_testpulse.txt';
...
% Must ends in '/'
resultDir = 'C:\Users\manho\OneDrive - University of Pittsburgh\data\ELE project\ephys\analysis\membrane_props\';
...
% Save results
save([resultDir 'memPropReport'],'memPropReport');
writetable(memPropReport,[resultDir 'memPropReport.xlsx'],'WriteRowNames',true);
